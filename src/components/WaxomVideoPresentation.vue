  ...
  <div class="waxom-video-presentation video-present">
     <video src="../assets/video/rome.mp4" class="video-play" width="1920" height="705" ref="video" :class="{ 'video-play-activated': videoPlaying == 'played'}" @click="pauseVideo"></video>
        <div class="video-descr" v-show="videoPlaying == 'unplayed' ">
            ...
            <p class="video-txt">Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius, qui sequitur mutationem consuetudium.</p>
...
export default {
  name: 'waxom-video-presentation',
  data() {
    return{
      videoPlaying: 'unplayed'
    }
  },
  methods: {
    playVideo() {
      this.$refs.video.play();
      this.videoPlaying = 'played';
    },
    pauseVideo() {
      if (this.videoPlaying == 'paused') {
        this.$refs.video.play();
        this.videoPlaying = 'played';
      } else if (this.videoPlaying == 'played'){ 
        this.$refs.video.pause();
        this.videoPlaying = 'paused';
       }
    }
  },
  created() {
